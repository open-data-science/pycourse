...
Как любой мастер должен знать свой инструмент, так и любой человек, решивший пройти курс Pycourse, должен понимать тонкости рабочей среды. Как вы уже могли понять по прошлому занятию, всю (или большую часть) работы мы будем делать в `Jupyter Notebook`. Но бояться нечего: по сути, `Jupyter` -- это _продвинутый текстовый редактор_ с функцией запуска кода и получения результатов вычислений. Настолько продвинутый, что позволяет вам не только рисовать картинки и писать формулы, но даже строить целые интерактивные карты:

```{figure} /_static/python/ru/jupyter_l3/interactive_map.gif
...
```{figure} /_static/python/ru/jupyter_l3/jupyter_ui_1.png
:name: jupyter_ui_1
:width: 600px
...
```{figure} /_static/python/ru/jupyter_l3/jupyter_ui_2.png
:name: jupyter_ui_2
:width: 600px
...
```{figure} /_static/python/ru/jupyter_l3/jupyter_ui_3.png
:name: jupyter_ui_3
:width: 600px
...
```{figure} /_static/python/ru/jupyter_l3/jupyter_ui_4.png
:name: jupyter_ui_4
:width: 600px
...
```{figure} /_static/python/ru/jupyter_l3/jupyter_ui_5.png
:name: jupyter_ui_5
:width: 600px
```

```{figure} /_static/python/ru/jupyter_l3/jupyter_ui_6.png
:name: jupyter_ui_6
:width: 600px
...
```{figure} /_static/python/ru/jupyter_l3/jupyter_ui_7.png
:name: jupyter_ui_7
:width: 600px
...
```{figure} /_static/python/ru/jupyter_l3/jupyter_ui_8.png
:name: jupyter_ui_8
:width: 600px
...
```{figure} /_static/python/ru/jupyter_l3/jupyter_ui_9.png
:name: jupyter_ui_9
:width: 600px
...
```{figure} /_static/python/ru/jupyter_l3/jupyter_ui_10.png
:name: jupyter_ui_10
:width: 600px
