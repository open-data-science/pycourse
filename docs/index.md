...
!!! danger "О чём это всё"
    ...
    Проект вот запустился и находится в стадии разработки «основы python». Подискутировать о курсе можно [тут](https://github.com/open-data-science/pycourse/discussions).
